...
if __name__ == '__main__':
    # url = "http://1258455058.vod2.myqcloud.com/1def07cdvodcq1258455058/c939df1d243791579861068255/f0.aac"
    # url = "http://1258455058.vod2.myqcloud.com/1def07cdvodcq1258455058/802d7181243791579853455483/f0.aac"
    # url = "http://1258455058.vod2.myqcloud.com/1def07cdvodcq1258455058/de47bddc243791579844314367/f0.aac"
    # url = "http://1258455058.vod2.myqcloud.com/1def07cdvodcq1258455058/9ad90acb243791579843745789/f0.aac"
    url = "http://1258455058.vod2.myqcloud.com/1def07cdvodcq1258455058/654b9fbd243791579863135582/f0.aac"
    params = {
        "url": url,
        "save_path": "",  # 保存文件的路径
        "file_name": "{}-{}".format(url.split("/")[-2], url.split("/")[-1]),
        "headers": {
    ...
    # res = downloader.get_resp_header_info()
    # print(res)
    downloader.run()
